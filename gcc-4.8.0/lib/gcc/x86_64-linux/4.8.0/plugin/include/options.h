...
#endif
#ifdef GENERATOR_FILE
extern const char *asan_offset;
#else
  const char *x_asan_offset;
#define asan_offset global_options.x_asan_offset
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_fasan_offset_ = 459,                   /* -fasan-offset= */
  OPT_fasm = 460,                            /* -fasm */
  ...
  OPT_m128bit_long_double = 1038,            /* -m128bit-long-double */
  OPT_m32 = 1039,                            /* -m32 */
  OPT_m3dnow = 1040,                         /* -m3dnow */
  OPT_m3dnowa = 1041,                        /* -m3dnowa */
  OPT_m64 = 1042,                            /* -m64 */
  OPT_m80387 = 1043,                         /* -m80387 */
  OPT_m8bit_idiv = 1044,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1045,             /* -m96bit-long-double */
  OPT_mabi_ = 1046,                          /* -mabi= */
  OPT_mabm = 1047,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1048,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1049,                 /* -maddress-mode= */
  OPT_madx = 1050,                           /* -madx */
  OPT_maes = 1051,                           /* -maes */
  OPT_malign_double = 1052,                  /* -malign-double */
  OPT_malign_functions_ = 1053,              /* -malign-functions= */
  OPT_malign_jumps_ = 1054,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1055,                  /* -malign-loops= */
  OPT_malign_stringops = 1056,               /* -malign-stringops */
  OPT_mandroid = 1057,                       /* -mandroid */
  OPT_march_ = 1058,                         /* -march= */
  OPT_masm_ = 1059,                          /* -masm= */
  OPT_mavx = 1060,                           /* -mavx */
  OPT_mavx2 = 1061,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1062,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1063,  /* -mavx256-split-unaligned-store */
  OPT_mbionic = 1064,                        /* -mbionic */
  OPT_mbmi = 1065,                           /* -mbmi */
  ...
  /* OPT_mcpu_ = 1070, */                    /* -mcpu= */
  OPT_mcrc32 = 1071,                         /* -mcrc32 */
  OPT_mcx16 = 1072,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1073,            /* -mdispatch-scheduler */
  OPT_mf16c = 1074,                          /* -mf16c */
  OPT_mfancy_math_387 = 1075,                /* -mfancy-math-387 */
  OPT_mfentry = 1076,                        /* -mfentry */
  OPT_mfma = 1077,                           /* -mfma */
  OPT_mfma4 = 1078,                          /* -mfma4 */
  OPT_mforce_drap = 1079,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1080,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1081,                       /* -mfpmath= */
  OPT_mfsgsbase = 1082,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1083, */              /* -mfused-madd */
  OPT_mfxsr = 1084,                          /* -mfxsr */
  OPT_mglibc = 1085,                         /* -mglibc */
  OPT_mhard_float = 1086,                    /* -mhard-float */
  OPT_mhle = 1087,                           /* -mhle */
  OPT_mieee_fp = 1088,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1089,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1090,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1091,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1092, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1093,         /* -mlarge-data-threshold= */
  OPT_mlong_double_64 = 1094,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1095,                /* -mlong-double-80 */
  OPT_mlwp = 1096,                           /* -mlwp */
  OPT_mlzcnt = 1097,                         /* -mlzcnt */
  OPT_mmmx = 1098,                           /* -mmmx */
  OPT_mmovbe = 1099,                         /* -mmovbe */
  OPT_mms_bitfields = 1100,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1101,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1102,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1103,                  /* -mno-push-args */
  OPT_mno_red_zone = 1104,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1105,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1106,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1107,                          /* -mpc32 */
  OPT_mpc64 = 1108,                          /* -mpc64 */
  OPT_mpc80 = 1109,                          /* -mpc80 */
  OPT_mpclmul = 1110,                        /* -mpclmul */
  OPT_mpopcnt = 1111,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1112,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1113,     /* -mpreferred-stack-boundary= */
  OPT_mprfchw = 1114,                        /* -mprfchw */
  OPT_mpush_args = 1115,                     /* -mpush-args */
  OPT_mrdrnd = 1116,                         /* -mrdrnd */
  OPT_mrdseed = 1117,                        /* -mrdseed */
  OPT_mrecip = 1118,                         /* -mrecip */
  OPT_mrecip_ = 1119,                        /* -mrecip= */
  OPT_mred_zone = 1120,                      /* -mred-zone */
  OPT_mregparm_ = 1121,                      /* -mregparm= */
  OPT_mrtd = 1122,                           /* -mrtd */
  OPT_mrtm = 1123,                           /* -mrtm */
  OPT_msahf = 1124,                          /* -msahf */
  OPT_msoft_float = 1125,                    /* -msoft-float */
  OPT_msse = 1126,                           /* -msse */
  OPT_msse2 = 1127,                          /* -msse2 */
  OPT_msse2avx = 1128,                       /* -msse2avx */
  OPT_msse3 = 1129,                          /* -msse3 */
  OPT_msse4 = 1130,                          /* -msse4 */
  OPT_msse4_1 = 1131,                        /* -msse4.1 */
  OPT_msse4_2 = 1132,                        /* -msse4.2 */
  OPT_msse4a = 1133,                         /* -msse4a */
  /* OPT_msse5 = 1134, */                    /* -msse5 */
  OPT_msseregparm = 1135,                    /* -msseregparm */
  OPT_mssse3 = 1136,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1137,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1138,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1139,            /* -mstringop-strategy= */
  OPT_mtbm = 1140,                           /* -mtbm */
  OPT_mtls_dialect_ = 1141,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1142,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1143,                         /* -mtune= */
  OPT_muclibc = 1144,                        /* -muclibc */
  OPT_mveclibabi_ = 1145,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1146,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1147,                    /* -mvzeroupper */
  OPT_mx32 = 1148,                           /* -mx32 */
  OPT_mxop = 1149,                           /* -mxop */
  OPT_mxsave = 1150,                         /* -mxsave */
  OPT_mxsaveopt = 1151,                      /* -mxsaveopt */
  OPT_n = 1152,                              /* -n */
  OPT_no_canonical_prefixes = 1153,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1154,              /* -no-integrated-cpp */
  OPT_nocpp = 1155,                          /* -nocpp */
  OPT_nodefaultlibs = 1156,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1157,                   /* -nostartfiles */
  OPT_nostdinc = 1158,                       /* -nostdinc */
  OPT_nostdinc__ = 1159,                     /* -nostdinc++ */
  OPT_nostdlib = 1160,                       /* -nostdlib */
  OPT_o = 1161,                              /* -o */
  OPT_p = 1162,                              /* -p */
  OPT_pass_exit_codes = 1163,                /* -pass-exit-codes */
  /* OPT_pedantic = 1164, */                 /* -pedantic */
  OPT_pedantic_errors = 1165,                /* -pedantic-errors */
  OPT_pg = 1166,                             /* -pg */
  OPT_pie = 1167,                            /* -pie */
  OPT_pipe = 1168,                           /* -pipe */
  OPT_posix = 1169,                          /* -posix */
  OPT_print_file_name_ = 1170,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1171,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1172,          /* -print-multi-directory */
  OPT_print_multi_lib = 1173,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1174,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1175,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1176,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1177,               /* -print-prog-name= */
  OPT_print_search_dirs = 1178,              /* -print-search-dirs */
  OPT_print_sysroot = 1179,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1180,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1181,                        /* -profile */
  OPT_pthread = 1182,                        /* -pthread */
  OPT_quiet = 1183,                          /* -quiet */
  OPT_r = 1184,                              /* -r */
  OPT_rdynamic = 1185,                       /* -rdynamic */
  OPT_remap = 1186,                          /* -remap */
  OPT_s = 1187,                              /* -s */
  OPT_s_bc_abi = 1188,                       /* -s-bc-abi */
  OPT_save_temps = 1189,                     /* -save-temps */
  OPT_save_temps_ = 1190,                    /* -save-temps= */
  OPT_shared = 1191,                         /* -shared */
  OPT_shared_libgcc = 1192,                  /* -shared-libgcc */
  /* OPT_specs = 1193, */                    /* -specs */
  OPT_specs_ = 1194,                         /* -specs= */
  OPT_static = 1195,                         /* -static */
  OPT_static_libasan = 1196,                 /* -static-libasan */
  OPT_static_libgcc = 1197,                  /* -static-libgcc */
  OPT_static_libgcj = 1198,                  /* -static-libgcj */
  OPT_static_libgfortran = 1199,             /* -static-libgfortran */
  OPT_static_libgo = 1200,                   /* -static-libgo */
  OPT_static_libstdc__ = 1201,               /* -static-libstdc++ */
  OPT_static_libtsan = 1202,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1203, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1204, */                /* -std=c++0x */
  OPT_std_c__11 = 1205,                      /* -std=c++11 */
  OPT_std_c__1y = 1206,                      /* -std=c++1y */
  OPT_std_c__98 = 1207,                      /* -std=c++98 */
  OPT_std_c11 = 1208,                        /* -std=c11 */
  /* OPT_std_c1x = 1209, */                  /* -std=c1x */
  /* OPT_std_c89 = 1210, */                  /* -std=c89 */
  OPT_std_c90 = 1211,                        /* -std=c90 */
  OPT_std_c99 = 1212,                        /* -std=c99 */
  /* OPT_std_c9x = 1213, */                  /* -std=c9x */
  OPT_std_f2003 = 1214,                      /* -std=f2003 */
  OPT_std_f2008 = 1215,                      /* -std=f2008 */
  OPT_std_f2008ts = 1216,                    /* -std=f2008ts */
  OPT_std_f95 = 1217,                        /* -std=f95 */
  OPT_std_gnu = 1218,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1219, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1220, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1221,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1222,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1223,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1224,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1225, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1226, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1227,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1228,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1229, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1230, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1231,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1232, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1233, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1234, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1235,                     /* -std=legacy */
  OPT_symbolic = 1236,                       /* -symbolic */
  OPT_t = 1237,                              /* -t */
  OPT_time = 1238,                           /* -time */
  OPT_time_ = 1239,                          /* -time= */
  OPT_tno_android_cc = 1240,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1241,                 /* -tno-android-ld */
  OPT_traditional = 1242,                    /* -traditional */
  OPT_traditional_cpp = 1243,                /* -traditional-cpp */
  OPT_trigraphs = 1244,                      /* -trigraphs */
  OPT_u = 1245,                              /* -u */
  OPT_undef = 1246,                          /* -undef */
  OPT_v = 1247,                              /* -v */
  OPT_version = 1248,                        /* -version */
  OPT_w = 1249,                              /* -w */
  OPT_wrapper = 1250,                        /* -wrapper */
  OPT_x = 1251,                              /* -x */
  OPT_z = 1252,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
